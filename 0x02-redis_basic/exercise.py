#!/usr/bin/env python3
"""Module that contains functions that declares a redis class and methods"""
import redis
...
def count_calls(method: Callable) -> Callable:
    ...
    def wrapper(self, *args, **kwargs):
        """wraps the function and return the wrapper"""
...
def call_history(method: Callable) -> Callable:
    """stores the history of inputs and outputs for a specific function"""
    @wraps(method)
    def wrapper(self, *args, **kwargs):
        """wraps the function and return the wrapper"""
        input = str(args)
...
class Cache:
    ...
    def __init__(self):
        """initialise to store an instance and flush"""
